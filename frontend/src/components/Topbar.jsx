...
const MODULE_TITLES = {
  ...
  'trading-imperium': { title: 'Trading Imperium', subtitle: 'Vue d’ensemble · 6 licences prop firm · MT5 en direct' },
  'trading-imperium-trades': { title: 'Trading Imperium', subtitle: 'Trades · Historique complet des positions fermées' },
  'trading-imperium-events': { title: 'Trading Imperium', subtitle: 'Événements · Resets, topups, breaches' },
